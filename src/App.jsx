...
const App = () => {
  ...
  const uploadImage = async (e) =>{
    ...
    const response = await fetch('https://imagenerateai-backend.onrender.com/upload', options);
  ...
  const getImages = async () => { 
    try {
        ...
        const response = await fetch('https://imagenerateai-backend.onrender.com/images', options);
        const data = await response.json();
   ...
   const generateVariations = async () => {
    ...
    try {
      ...
      const response = await fetch('https://imagenerateai-backend.onrender.com/variations', options);
